import { SecondFoodExpence, SecondTransportExpence, SecondPersonalExpence, SecondHousingExpence, SecondSavingExpence } from "../../data/CalSecondMonthExpence";
import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";


export default function SecondIndividualData() {
    ...
    const value = location.pathname.replace("/cashflow/SixMonth/2/", "");
            ...
            <div className='flex flex-row '>
                ...
                <div className="bg-[#B8D7DE8C] rounded-md mt-4 ml-64  h-[100vh] w-[60vw]  grow px-12 py-8">
                    ...
                    <div className="bg-white w-full h-fit rounded-2xl mt-2 px-12 py-8">
                        ...
                        {
                            location.pathname == "/cashflow/SixMonth/2/Food" && (Foodlist || []).map((item, index) => (
                        ...
                        {
                            location.pathname == "/cashflow/SixMonth/2/Transport" && (TransportListing || []).map((item, index) => (
                                <div key={index} className="flex flex-row justify-between mt-4 border-b pt-4 pb-2 pl-2 ">
                                    <div className="flex flex-row gap-2">
                        ...
                        {
                            location.pathname == "/cashflow/SixMonth/2/Housing" && (HousingListing || []).map((item, index) => (
                                <div key={index} className="flex flex-row justify-between mt-4 border-b pt-4 pb-2 pl-2 ">
                                    <div className="flex flex-row gap-2">
                        ...
                        {
                            location.pathname == "/cashflow/SixMonth/2/Saving" && (SavingListing || []).map((item, index) => (
                                <div key={index} className="flex flex-row justify-between mt-4 border-b pt-4 pb-2 pl-2 ">
                                    <div className="flex flex-row gap-2">
                        ...
                        {
                            location.pathname == "/cashflow/SixMonth/2/PersonalExpence" && (PersonalListing || []).map((item, index) => (
                                <div key={index} className="flex flex-row justify-between mt-4 border-b pt-4 pb-2 pl-2 ">
                                    <div className="flex flex-row gap-2">
