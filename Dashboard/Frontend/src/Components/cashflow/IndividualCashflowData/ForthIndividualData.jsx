import { ForthFoodExpence ,ForthHousingExpence ,ForthSavingExpence ,ForthPersonalExpence ,ForthTransportExpence } from "../../data/CalForthMonthExpence";
import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";

// Main component for displaying individual expense data
export default function ForthIndividualData(urlId) {
