...
import SecondMonth from "../MonthList/SecondMonth.jsx";



export default function SecondIndividual(){
  ...
  <div className='flex flex-row '>
                ...
                <div className="bg-[#B8D7DE8C] rounded-md mt-4 ml-64  h-fit w-[60vw]  grow px-12 py-8">
