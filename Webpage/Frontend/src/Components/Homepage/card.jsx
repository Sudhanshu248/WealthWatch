            ...
            <div className="px-12 py-4 max-[600px]:px-2 mx-auto my-8">
                ...
                <div className="cards grid grid-cols-2 px-6 py-8 mx-4 my-8 max-[750px]:grid-cols-1 max-[750px]:text-center flex justify-center items-center gap-12">
                    ...
                    <div className="text-center flex order-1 max-[750px]:order-2 flex justify-center items-center">
                        ...
                        <img className="w-[20rem] pr-3 mr-4 justify-center flex align-center rounded-lg ml-16" src="/image/home1.png" alt="" />
                    </div>
                ...
                <div className="cards grid grid-cols-2 px-6 py-8 mx-4 my-8 max-[750px]:grid-cols-1 max-[750px]:text-center flex justify-center items-center gap-12">
                    ...
                    <div className="text-center flex order-2 max-[750px]:order-2 flex justify-center items-center">
                        <img className="w-[20rem] pr-3 mr-4 justify-center flex align-center rounded-lg ml-16" src="/image/home2.png" alt="" />
                    </div>
                ...
                <div className="cards grid grid-cols-2 px-6 py-8 mx-4 my-8 max-[750px]:grid-cols-1 max-[750px]:text-center flex justify-center items-center gap-12">
                    ...
                    <div className="text-center flex order-1 max-[750px]:order-2 flex justify-center items-center">
                        <img className="w-[20rem] pr-3 mr-4 justify-center flex align-center rounded-lg ml-16" src="/image/home3.png" alt="" />
                    </div>
                ...
                <div className="cards grid grid-cols-2 px-6 py-8 mx-4 my-8 max-[750px]:grid-cols-1 max-[750px]:text-center flex justify-center items-center gap-12">
                    ...
                    <div className="text-center flex order-2 max-[750px]:order-2 flex justify-center items-center">
                        <img className="w-[20rem] pr-3 mr-4 justify-center flex align-center rounded-lg ml-16" src="/image/home4.png" alt="" />
                    </div>
