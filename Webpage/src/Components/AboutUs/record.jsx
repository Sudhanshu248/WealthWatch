...
export default function Record() {
    ...
    const countersData = [
        { image:"/image/review1.png", label: "Happy Clients", count: 247, suffix: "k+"},
        { image:"/image/review2.png", label: "Years of Expereince", count: 4, suffix: "+" },
        { image:"/image/review3.png", label: "Accuracy Rate", count: 95, suffix: "%" },
        { image:"/image/review4.png", label: "Reviews of Users", count: 4, suffix: ".5☆" },
    ];
