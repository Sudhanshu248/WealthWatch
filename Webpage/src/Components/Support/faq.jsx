...
const faqs = [
  {
    ...
    answer: "An expense tracker is a tool or app that helps you record, categorize, and monitor your spending to manage your finances effectively.",
  },
  {
    question: "How do I add an expense or income?",
    answer: "Go to the add transaction section, enter the details (amount, category, date), and save.",
  },
  {
    question: "Is my data secure?",
    answer: "Yes, all your data is stored securely and never shared with third parties.",
  },
  {
    question: "Can I set budgets for different categories?",
    answer: "Yes, you can set monthly budgets per category and track your progress.",
  },
  {
