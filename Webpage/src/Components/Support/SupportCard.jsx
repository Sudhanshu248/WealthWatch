            ...
            <div className="text-center flex flex-row flex-wrap align-item-center justify-center-safe px-8 mt-6 mb-12 gap-16">
                ...
                <div className="flip-card  ">
                    <div className="flip-card-inner p-4">
                        ...
                        <div className="flip-card-back">
                            <p className="text-white px-4">Your financial data is protected with bank-level encryption and secure cloud storage. We never share or sell your information—privacy and safety come first.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flip-card  ">
                    <div className="flip-card-inner p-4">
                        ...
                        <div className="flip-card-back">
                            <p className="text-white px-4">Set savings goals and let the app guide you with automated plans and progress tracking.</p>
                        </div>
                    </div>
                </div>
            </div>
